...
import com.gintoci.secondkill.dao.ItemDOMapper;
import com.gintoci.secondkill.dao.ItemStockDOMapper;
import com.gintoci.secondkill.dataobject.ItemDO;
import com.gintoci.secondkill.dataobject.ItemStockDO;
...
@Service
  class ItemServiceImpl implements ItemService {
    ...
    private ItemDO convertItemDOFromItemModel(ItemModel itemModel){
        ...
        itemDO.setPrice(itemModel.getPrice().doubleValue());//BigDecimal转double防止精度损失
        return itemDO;
    }
    ...
    public List<ItemModel> listItem() {
        ...
        //使用java8的streamAPI，将itemDOList遍历转化为itemModelList
